...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""MyActionMap"",
            ""id"": ""4d49bc54-d2b0-4904-83c7-a9e02b5cf3b8"",
            ""actions"": [
                {
                    ""name"": ""RestartGame"",
                    ""type"": ""Button"",
                    ""id"": ""813cf2bf-d438-43ea-97ca-b0f388a61a7b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""BackToMenu"",
                    ""type"": ""Button"",
                    ""id"": ""e49d357b-8f78-490b-b418-beb1aae11f77"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""LeftClick"",
                    ""type"": ""Button"",
                    ""id"": ""801c5be2-6159-4580-93a0-e0876f14798e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""RightClick"",
                    ""type"": ""Button"",
                    ""id"": ""0b0f208d-f1b1-42e1-a2af-59ecf64998c4"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""f976126b-d636-4f2b-b2db-00c6b23de69c"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""c5deba64-1d65-49bb-bf87-65c621a8e1fe"",
                ...
                {
                    ""name"": """",
                    ""id"": ""86cbba97-f1a4-420f-bd6a-58f2d4444bcb"",
                    ""path"": ""<Mouse>/leftButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""f0577663-9900-43f4-9b41-18d19877b2c6"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_MyActionMap_BackToMenu = m_MyActionMap.FindAction("BackToMenu", throwIfNotFound: true);
        m_MyActionMap_LeftClick = m_MyActionMap.FindAction("LeftClick", throwIfNotFound: true);
        m_MyActionMap_RightClick = m_MyActionMap.FindAction("RightClick", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_MyActionMap.enabled, "This will cause a leak and performance issues, InputSystem_Actions.MyActionMap.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_MyActionMap_BackToMenu;
    private readonly InputAction m_MyActionMap_LeftClick;
    private readonly InputAction m_MyActionMap_RightClick;
    /// <summary>
    /// Provides access to input actions defined in input action map "MyActionMap".
    /// </summary>
    public struct MyActionMapActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public MyActionMapActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "MyActionMap/RestartGame".
        /// </summary>
        public InputAction @RestartGame => m_Wrapper.m_MyActionMap_RestartGame;
        /// <summary>
        /// Provides access to the underlying input action "MyActionMap/BackToMenu".
        /// </summary>
        public InputAction @BackToMenu => m_Wrapper.m_MyActionMap_BackToMenu;
        /// <summary>
        /// Provides access to the underlying input action "MyActionMap/LeftClick".
        /// </summary>
        public InputAction @LeftClick => m_Wrapper.m_MyActionMap_LeftClick;
        /// <summary>
        /// Provides access to the underlying input action "MyActionMap/RightClick".
        /// </summary>
        public InputAction @RightClick => m_Wrapper.m_MyActionMap_RightClick;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="MyActionMapActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="MyActionMapActions" />
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="MyActionMapActions.UnregisterCallbacks(IMyActionMapActions)" />.
        /// </summary>
        /// <seealso cref="MyActionMapActions.UnregisterCallbacks(IMyActionMapActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="MyActionMapActions.AddCallbacks(IMyActionMapActions)" />
        /// <seealso cref="MyActionMapActions.RemoveCallbacks(IMyActionMapActions)" />
        /// <seealso cref="MyActionMapActions.UnregisterCallbacks(IMyActionMapActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="MyActionMapActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "MyActionMap" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="MyActionMapActions.AddCallbacks(IMyActionMapActions)" />
    /// <seealso cref="MyActionMapActions.RemoveCallbacks(IMyActionMapActions)" />
